...
\lstinputlisting[caption = Παράδειγμα χρήσης της std::stack (stl\_stack\_example.cpp), multicols=2]{lab05/stl_stack_example.cpp}
...
\lstinputlisting[caption = Παράδειγμα χρήσης της std::queue (stl\_queue\_example.cpp), multicols=2]{lab05/stl_queue_example.cpp}
...
\lstinputlisting[caption = Έλεγχος παλινδρομικής φράσης (lab05\_ex1.cpp), multicols=2]{lab05/lab05_ex1.cpp}
...
\lstinputlisting[caption = Μετατροπή δυαδικού σε δεκαδικό (lab05\_ex2.cpp), multicols=2]{lab05/lab05_ex2.cpp}
