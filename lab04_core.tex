...
\lstinputlisting[caption = Παράδειγμα με vectors (vector.cpp)]{lab04/vector.cpp}
...
\lstinputlisting[caption = Παράδειγμα με deque (deque.cpp)]{lab04/deque.cpp}
...
\lstinputlisting[caption = Παράδειγμα με array (array.cpp)]{lab04/array.cpp}
...
\lstinputlisting[caption = Παράδειγμα με list (forward\_list.cpp)]{lab04/list.cpp}
...
\lstinputlisting[caption = Παράδειγμα με forward\_list (forward\_list.cpp)]{lab04/forward_list.cpp}
