...
\lstinputlisting[caption=Επανάληψη λογικής κώδικα (minmax.cpp),multicols=2]{lab02/minmax.cpp}
...
\lstinputlisting[caption=Χρήση template για αποφυγή επανάληψης λογικής κώδικα (minmaxt.cpp),multicols=2]{lab02/minmaxt.cpp}
...
\lstinputlisting[caption=Παράδειγμα με προσθήκη στοιχείων σε vector (container1.cpp),multicols=2]{lab02/container1.cpp}
...
\lstinputlisting[caption=Αρχικοποίηση vectors (container2.cpp),multicols=2]{lab02/container2.cpp}
...
\lstinputlisting[caption=Παράδειγμα με map (container3.cpp),multicols=2]{lab02/container3.cpp}
...
\lstinputlisting[caption = Τέσσερις διαφορετικοί τρόποι προσπέλασης των στοιχείων ενός vector (iterator1.cpp),multicols=2]{lab02/iterator1.cpp}
...
\lstinputlisting[caption = Τρεις διαφορετικοί τρόποι προσπέλασης των στοιχείων ενός map (iterator2.cpp),multicols=2]{lab02/iterator2.cpp}

\lstinputlisting[style=DOS,multicols=2]{lab02/iterator2.out}
...
\lstinputlisting[caption = Ταξινόμηση λίστας με αντικείμενα - α' τρόπος (sort2.cpp),multicols=2]{lab02/sort2.cpp}
...
\lstinputlisting[caption = Ταξινόμηση λίστας με αντικείμενα - β' τρόπος (sort3.cpp),multicols=2]{lab02/sort3.cpp}

\lstinputlisting[caption = Ταξινόμηση λίστας με αντικείμενα - γ' τρόπος (sort4.cpp),multicols=2]{lab02/sort4.cpp}
...
\lstinputlisting[caption = Ταξινόμηση λίστας με εγγραφές (sort5.cpp),multicols=2]{lab02/sort5.cpp}
...
\lstinputlisting[caption = Αναζήτηση σε ταξινομημένο πίνακα (search1.cpp),multicols=2]{lab02/search1.cpp}

\lstinputlisting[style=DOS]{lab02/search1.out}

\lstinputlisting[caption = Αναζήτηση σε ταξινομημένο διάνυσμα (search2.cpp),multicols=2]{lab02/search2.cpp}
...
\lstinputlisting[style=DOS,multicols=2]{lab02/lambda1.out}
...
\lstinputlisting[caption = Λύση παραδείγματος 1 (lab02\_ex1.cpp),multicols=2]{lab02/lab02_ex1.cpp}
...
\lstinputlisting[caption = Λύση παραδείγματος 2 (lab02\_ex2.cpp),multicols=2]{lab02/lab02_ex2.cpp}
...
\lstinputlisting[caption = Λύση παραδείγματος 3 (lab02\_ex3.cpp),multicols=2]{lab02/lab02_ex3.cpp}
